      ...
      <Layout>
        ...
        <div className="mx-4">
            ...
            <div className="grid grid-cols-12 mt-4">
                <div className="col-span-12 md:col-span-8 sm:col-span-6 mb-3">
                    ...
                    <div className="grid grid-cols-6">
                        {
                            [10000, 20000, 50000, 100000,250000, 500000].map((money, index)=>(
                                <div className="col-span-2 px-3 py-2 mb-2 font-semibold rounded-lg shadow-md transition duration-200 ease-in-out" onClick={()=>changeValue(money+'')} style={{height:'50px'}} key={index}>
